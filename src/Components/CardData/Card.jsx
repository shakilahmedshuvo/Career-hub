            ...
            <div className='w-full h-72 flex items-center shadow-2xl border-2 mt-6 p-2 gap-10'>
                ...
                <div>
                    ...
                    <div className='flex mt-5'>
                        <h2 className='w-30 mr-5 border-violet-300 p-3 px-6 py-1 font-bold text-violet-400 border-2'>{job?.first}</h2>
                        <h2 className='w-30 border-violet-300 p-3 px-6 py-1 font-bold text-violet-400 border-2'>{time?.second}</h2>
                    </div>
