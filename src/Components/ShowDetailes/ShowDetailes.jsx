...
const ShowDetails = () => {
    ...
    return (
        <div>
            ...
            <div
                className='grid md:grid-cols-2 mb-10 px-16 mt-12 gap-20'>
                {/* right side div */}
                <div
                    className='text-lg'>
                    <h4
                    ...
                    <h4
                        className='mt-8 mb-12'><span className='font-bold'>
                            Experience:
                        </span>
                        {state.experiences}
                    </h4>
                ...
                <div>
                    <div
                        className='bg-blue-100 p-5 rounded-xl w-96 shadow-lg mt-6'>
                        <h4
                    ...
                    <div className='md:relative left-8 w-100%'>
                        <button
                            onClick={() => handleBtn(state.id)}
                            className=' header-btn mb-6 mt-8'>
                            Apply Now
                        </button>
                    </div>
                </div>
