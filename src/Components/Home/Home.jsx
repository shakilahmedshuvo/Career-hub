            ...
            <div>
                ...
                <div className='md:flex justify-around mx-60 mt-20'>
                    <div className='ml-2'>
                        ...
                        <button
                            className='mt-4 header-btn px-4'>
                            Get Started
                        </button>
                    </div>
                    <div>
                ...
                <div className='text-center mt-20'>
                    ...
                    <p
                        className='mt-4  text-gray-500 font-medium'>Explore thousands of job opportunities with all the information you need. Its your future
                    </p>
                    {/* map and grid section start */}
                    <div
                        className='mt-14 grid md:grid-cols-4 mx-20'>
                        {
                ...
                {/* map and grid section start */}
                <div
                    className='grid md:grid-cols-2 gap-12 mt-16 md:mx-44 mb- 8'>
                    {
